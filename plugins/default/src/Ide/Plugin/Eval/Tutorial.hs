...
attempting to use module ‘fake_uid:Ide.Plugin.Eval.CodeLens’ (/Users/titto/workspace/EXTERNAL/haskell-language-server/plugins/default/src/Ide/Plugin/Eval/CodeLens.hs) which is not loaded
